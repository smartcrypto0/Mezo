...
## What the Matching Market Is Not

- **Not an official Mezo product** — The Matching Market is built and operated by the community, not by Mezo
- **Not for emissions** — Boost gauges don't receive MEZO emissions; they only determine boost multipliers
- **Not required** — A veBTC position without boost still operates at 1x and earns passive fees
- **Not the same as gauge voting** — Gauge voting directs emissions; the Matching Market pairs veBTC with veMEZO
...
:::danger[Warning]
Users should only deposit funds they can afford to lose and verify contract addresses independently.
:::
